...
export class DDGuild extends Base {
  ...
  update(payload: Guild) {
    ...
    this.afkChannelId = payload.afkChannelId
      ? snowflakeToBigint(payload.afkChannelId)
      : undefined;
    this.publicUpdatesChannelId = payload.publicUpdatesChannelId
      ? snowflakeToBigint(payload.publicUpdatesChannelId)
      : undefined;
    this.rulesChannelId = payload.rulesChannelId
      ? snowflakeToBigint(payload.rulesChannelId)
      : undefined;
    this.systemChannelId = payload.systemChannelId
      ? snowflakeToBigint(payload.systemChannelId)
      : undefined;
    this.widgetChannelId = payload.widgetChannelId
      ? snowflakeToBigint(payload.widgetChannelId)
      : undefined;
  ...
  bannerURL(size?: DiscordImageSize, format?: DiscordImageFormat) {
    return this.client.guildBannerURL(
      this.id,
      this.banner,
      this.animatedBanner,
      size,
  ...
  async auditLogs(options: Partial<GetGuildAuditLog>) {
    return await this.client.auditLogs(this.id, options);
  }
  ...
  async bans() {
    return await this.client.bans(this.id);
  }
  ...
  toJSON() {
    ...
    return {
      ...
      name: this.name,
      icon: this.icon
        ? iconBigintToHash(this.icon, this.animatedIcon)
        : undefined,
      iconHash: undefined,
      splash: this.splash
        ? iconBigintToHash(this.splash, this.animatedSplash)
        : undefined,
      ...
      banner: this.banner
        ? iconBigintToHash(this.banner, this.animatedBanner)
        : null,

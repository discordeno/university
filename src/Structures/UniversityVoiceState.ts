...
export class UniversityVoiceState {
  /** The client itself */
  client: Client;
  ...
  update(data: VoiceState) {
    ...
    this.channelId = data.channelId
      ? snowflakeToBigint(data.channelId)
      : undefined;
    this.sessionId = data.sessionId;
    this.requestToSpeakTimestamp = data.requestToSpeakTimestamp
      ? Date.parse(data.requestToSpeakTimestamp)
      : undefined;
...
export default UniversityVoiceState;
